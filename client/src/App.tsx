...
const isDesktopApp =
  typeof window !== "undefined" && (window as any).__FREEAPI_DESKTOP__ === true;
              ...
              <main className="max-w-6xl mx-auto px-6 py-8">
                <PageBoundary>
                  <Routes>
                    ...
                    />
                    <Route
                      path="/models/embeddings/:id"
                      element={<EmbeddingDetailPage />}
                    />
                    <Route path="/models/image" element={<ImagePage />} />
                    <Route
                      path="/models/image/:id"
                      element={<MediaDetailPage modality="image" />}
                    />
                    <Route path="/models/audio" element={<AudioPage />} />
                    <Route
                      path="/models/audio/:id"
                      element={<MediaDetailPage modality="audio" />}
                    />
